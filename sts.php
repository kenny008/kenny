...
if(mysql_num_rows($result)==1){
	...
	$subject="Meggaprofits Trading Signal Account Activation";
	$header="FROM: TRADE SIGNAL ACCOUNT ACTIVATION\n";
	$message="TRADE SIGNAL ACCOUNT ACTIVATION"."\n"."\n";
	...
	$header="FROM:Meggaprofits Trade Signal Login Details\n";
...
<?php require_once("includes/shts.php");?>
