...
<div id="sant">
<p><font size="+2" color="#ca2722">Widthraws Request</font></p>
...
<?php
$queryc="SELECT * FROM withd WHERE pen='Pending' AND cat='withdraw'";
$resultc=mysql_query($queryc,$connection);
	while($resset=mysql_fetch_array($resultc)){
	echo"<tr>";
echo"<td align=\"center\"><a href=\"ddashm.php?lam={$resset['id']}\" title=\"{$resset['email']}\">{$resset['fname']}</a></td>";
