...
if(mysql_num_rows($result)==1){
	...
	$header="FROM: Forex Signal Payment";
...
<p>Payment Method</p>
  ...
  <div id="jigi2">
<p>You can subscribe for your Forex trade signal service via any of the methods below.</p>
 </div>
 <div id="jigi3">
 ...
 <div id="jigi5d">
 <a href="tskrill.php"><img src="images/skrill.png" width="58" height="66" /></a><p>GBP, USD&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php   $hey=$_SESSION['iaakenn'];
...
if(mysql_num_rows($req)==1){
   ...
   <a href="tradesb.php?pay=wu"><img src="images/Western-Union-icon.png" width="58" height="66" /></a><p>GBP, USD&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php   $hey=$_SESSION['iaakenn'];
$queryq="SELECT * FROM trade WHERE id='$hey'";
$req=mysql_query($queryq,$connection);
if(mysql_num_rows($req)==1){
	$resq=mysql_fetch_array($req);
  ...
  <a href="tradesb.php?pay=pz"> <img src="images/Payza.png" width="58" height="46" /></a><p>GBP, USD&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php   $hey=$_SESSION['iaakenn'];
$queryq="SELECT * FROM trade WHERE id='$hey'";
$req=mysql_query($queryq,$connection);
if(mysql_num_rows($req)==1){
	$resq=mysql_fetch_array($req);
    ...
    <?php  }}?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Processing Time: 1 hour.</p><br />
  <br />
  <a href="tradesb.php?pay=wm"> <img src="images/WebMoney.png" width="58" height="46" /></a><p>GBP, USD&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php   $hey=$_SESSION['iaakenn'];
$queryq="SELECT * FROM trade WHERE id='$hey'";
$req=mysql_query($queryq,$connection);
if(mysql_num_rows($req)==1){
	$resq=mysql_fetch_array($req);
    ...
    <?php  }}?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Processing Time: 1 hour.</p><br />
  <br />
  <a href="tradesb.php?pay=pm"> <img src="images/pm2.jpg" width="58" height="46" /></a><p>GBP, USD&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php   $hey=$_SESSION['iaakenn'];
$queryq="SELECT * FROM trade WHERE id='$hey'";
$req=mysql_query($queryq,$connection);
if(mysql_num_rows($req)==1){
	$resq=mysql_fetch_array($req);
