...
?>
 <div id="jigi1">
<p>Skrill Payment Method (Binary Signal)</p>
 </div>
  <div id="jigi2">
...
<br />
Broker:<br />
<input type="text" name="tskr1" id="tskr" placeholder="&nbsp;&nbsp;Amount to Invest" value="Binary" readonly="readonly"/></p>
<p><br />
<?php   
$hey=$_SESSION['iaakenn'];
