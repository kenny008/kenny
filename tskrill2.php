...
?>
 ...
 <p><font color="#ca2722" size="+1"><b>SKRILL PAYMENT DETAILS (Forex Signal)</b></font></p>
 <p>Full Name: <?php    
...
<p><input type="hidden" name="detail1_description" value="FOREX SIGNAL PAYMENT"></p>
<p><input type="hidden" name="detail1_text" value="FOREX SIGNAL PAYMENT"></p>
<p><input type="hidden" name="confirmation_note" value="Meggaprofits"></p>
 <p><input type="submit" name="kalid" id="kalid" value="Pay With Skrill"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="tskrill.php">Edit Details</a></p>
 </form>
